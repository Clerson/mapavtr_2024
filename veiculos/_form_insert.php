        ...
        <div class="row gx-1 gy-1 text-center">
          <div class="col-sm">
            ...
            <div class="row gx-1 gy-1">
              <div class="col-sm" >
                <div class="form-floating">
                  <input type="text" class="form-control" name="vtrtipo" placeholder="Nomenclatura"  required >
            ...
            <div class="row gx-1 gy-1">
              <div class="col-sm" >
                <div class="form-floating">
                  <input type="text" class="form-control"  name="vtrodomatual"  placeholder="000000">
            ...
            <div class="row gx-1 gy-1">
              <div class="col-sm" > 
                <div class="form-floating">
                  <input type="text" class="form-control"  name="vtrvaloratualtgr"  placeholder="Valor Atual TGR" >
